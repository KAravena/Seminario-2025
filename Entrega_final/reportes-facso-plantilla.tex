...
\urlstyle{same}
\hypersetup{
  pdftitle={Ansiedad en matemática y rendimiento},
...
\title{Ansiedad en matemática y rendimiento}
\usepackage{etoolbox}
\makeatletter
...
\makeatother
\subtitle{Diferencias según nivel socioeconómico en estudiantes
chilenos}
...
\citeproc{ref-hembree1990}{Hembree, 1990a}).

Esto sitúa a la ansiedad matemática en un lugar estratégico para
entender cómo las estructuras de desigualdad se encarnan en experiencias
subjetivas de aprendizaje, dado que el problema no se reduce a saber o
no saber Matemática, sino que también incluye la forma en que el
estudiantado se siente al enfrentarse a esa disciplina
(\citeproc{ref-ashcraft2002}{Ashcraft, 2002};
...
Junto a lo anterior, la literatura ha mostrado también que la ansiedad
matemática no se distribuye de manera homogénea entre grupos sociales,
documentado de manera consistente que niñas y mujeres tienden a reportar
niveles más altos de ansiedad matemática que niños y hombres
(\citeproc{ref-bieg2015}{Bieg et~al., 2015};
...
En Chile, la política educativa reciente ha instalado el bienestar y la
socioemocionalidad como dimensiones prioritarias de la agenda escolar en
el marco de la reactivación educativa posterior a la pandemia, a través
de iniciativas que combinan apoyo académico y socioemocional
...
diferencia del origen social o de la estructura del sistema social, las
...
\citeproc{ref-pekrun2006}{Pekrun, 2006b}). La pregunta que se abre,
entonces, no es solo si la ansiedad matemática se asocia al rendimiento,
sino cómo interactúa con la desigualdad socioeconómica y con los
contextos escolares en los que el estudiantado aprende.

Hasta ahora, la literatura internacional sobre ansiedad matemática ha
estado fuertemente anclada en la psicología educacional, con énfasis en
...
et~al., 2016}). En el caso chileno, esta brecha es aún más marcada,
aunque se ha documentado extensamente la persistencia de brechas
socioeconómicas en Matemática y el rol de la composición socioeconómica
de las escuelas (\citeproc{ref-agencia2023resultados}{Agencia de Calidad
de la Educación, 2023c}; \citeproc{ref-mizala2012chile}{Mizala \&
Torche, 2012}), esta separación entre el estudio de las desigualdades
estructurales y el de los mecanismos emocionales es precisamente el
vacío que este estudio busca abordar.

El presente estudio busca articular estos campos y abordar la
desigualdad en Matemática desde una perspectiva que combine
determinantes estructurales, contextuales y psicoeducativos. El
...
posible examinar de manera más fina en qué medida la ansiedad matemática
ayuda a explicar las brechas por nivel socioeconómico y cómo se modifica
su efecto según el tipo de escuela y el clima que se vive en ella.
...
diferenciados por clase producen desigualdades en vocabulario, manejo de
normas institucionales y habilidades para desenvolverse en el sistema
...
Una revisión reciente sintetiza la evidencia comparada sobre la relación
entre estatus socioeconómico familiar y logro académico. Este análisis
distingue entre los componentes estructurales del estatus (educación,
ocupación e ingreso parental) y los patrones de inversión educativa,
clasificando estos últimos en materiales (recursos culturales, tutorías,
actividades extraescolares) y psicológicos (altas expectativas, apoyo
emocional, clima de aprendizaje) (\citeproc{ref-guo2025sesreview}{Guo,
2025}). Guo (\citeproc{ref-guo2025sesreview}{2025}) concluye que el
capital académico y cultural incluye tanto bienes simbólicos como
prácticas cotidianas de acompañamiento y participación en la vida
escolar, reforzando la idea de que la desigualdad de rendimiento se
enraíza en la estructura de oportunidades del hogar y en sus vínculos
con la escuela.

Evidencia chilena reciente con SIMCE de Matemática (6.º a 10.º básico)
muestra que el nivel socioeconómico del hogar, la composición
...
En otros contextos latinoamericanos también se observa la centralidad
del nivel socioeconómico individual y de la composición escolar. Para
Guatemala, se ha mostrado que el capital socioeconómico individual y el
promedio socioeconómico de las escuelas se asocian positivamente con el
rendimiento en Matemática, mientras que indicadores de desventaja como
alta repitencia se vinculan con peores resultados
(\citeproc{ref-Ortega2023-fi}{Ortega, 2023}). En Chile, estudios
cuasi-experimentales sobre programas de apoyo a la primera infancia como
Chile Crece Contigo evidencian efectos moderados en Lenguaje y
...
A partir de estos antecedentes teórico-empíricos sobre el gradiente
...
2007}). El estudiantado debe simultáneamente resolver la tarea y lidiar
...
frente a la ansiedad matemática. Para concluir, la literatura sitúa la
ansiedad matemática como un mecanismo en el que confluyen procesos
cognitivos (memoria de trabajo, atención), motivacionales (autoeficacia,
expectativas de control) y afectivos (temor al fracaso, amenaza de
estereotipo), estrechamente vinculado al rendimiento escolar
(\citeproc{ref-geary2021class}{Geary et~al., 2021}). Esto la convierte
en una candidata plausible para mediar o modular la relación entre el
origen social del estudiantado y sus resultados en Matemática,
especialmente en sistemas altamente desiguales donde las experiencias de
fracaso se concentran en determinados grupos socioeconómicos.
...
que climas que promueven el apoyo, la colaboración y la resignificación
del error tienden a atenuarlo (\citeproc{ref-OHara2022}{O'Hara et~al.,
2022}).
...
{\centering \includegraphics[width=1.1\linewidth,height=\textheight,keepaspectratio]{assets/Imagenes/conceptual_model.jpg}
...
En primer lugar, se incluye el sexo del estudiante, operacionalizado
...
cuantitativo. El análisis estadístico se realizó en el software R
...
individual en este caso del rendimiento en Matemática, se relaciona con
...
Finalmente, dada la relevancia teórica de los mecanismos de desigualdad
y estratificación escolar, se estiman modelos con interacciones entre
...
ansiedad ante Matemática sobre el rendimiento.
...
\emph{53}(2), 1051-1074. \url{https://doi.org/10.1007/s11135-018-0802-x}
